    ...
    public function orderdetail($id)
    {
        try {
           ...
           /**
            ...
            $query = CategoryStitch::select(
                'category_stitch.*',
                'category_stitch.id as category_stitch_id',

                // Keep ONLY category_stitch status
                'category_stitch.status as status',

                // ✅ Order table specific fields only
                'orders.id as order_id',
                'orders.order_no',
                'orders.user_id',
                'orders.user_name',
